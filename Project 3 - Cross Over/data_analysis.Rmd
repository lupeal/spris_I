...
ad_nobaseM <- glmmTMB(cbind(7-Ad, Ad) ~ treatment + period + week + (1 | ptid),
                      data = ad_wcont, family = binomial())
...
Adherence final model has week as continuous, no `base_` covariates, and accounts for zero inflation since when looking through the data many patients did adhere so 7-Ad will produce many zeros.
